...
namespace Utilities
{
    ...
    /// Hi Simon,
    /// 
    /// My name is Kevin Grigorenko, I own the Utilities package
    /// (http://www.codeplex.com/Utilities). I found your HtmlAgilityPack code and
    ...
    {
        // for the stateful version
        private uint _crc32 = 0;

        static private uint[] Crc32Array =  // Crc polynomial 0xedb88320 
		{
        ...
        public uint AddToCrc32(ushort c)
        {
            ...
            _crc32 = Update(hiByte, _crc32);
            _crc32 = Update(lowByte, _crc32);
            return ~_crc32;
        }
        ...
        public static uint Compute(Stream stream)
        {
            ...
            do
            {
                ...
                if (b >= 0)
                {
                    oldCrc32 = Update((byte)b, oldCrc32);
                }
            }
            while (b != -1);
            return ~oldCrc32;
        ...
        public static uint Compute(string text)
        {
            ...
            for (int i = 0; len > 0; i++)
            {
                ...
                unchecked
                {
                    lowByte = (byte)(u & 0x00FF);
                    hiByte = (byte)(u >> 8);
                }
                oldCrc32 = Update(hiByte, oldCrc32);
                oldCrc32 = Update(lowByte, oldCrc32);
            }
        ...
        public static uint Compute(byte[] bytes)
        {
            ...
            {
                --len;
                oldCrc32 = Update(bytes[len], oldCrc32);
            }
            return ~oldCrc32;
        }
    }
