...
namespace Utilities
{
    ...
    {
        private static List<Utilities.Win32.Win32Structures.TIME_ZONE_INFORMATION> s_systemTimeZones;
        ...
        /// <summary>
        /// Wrapper around <see cref="Utilities.Win32.Win32Interfaces.IAssemblyName"/>
        /// </summary>
        [CLSCompliant(false)]
        public class GacAssemblyName : IComWrapper<Utilities.Win32.Win32Interfaces.IAssemblyName>
        {
            private Utilities.Win32.Win32Interfaces.IAssemblyName m_assemblyName;

            /// <summary>
            /// Initializes a new instance of the <see cref="AssemblyName"/> class.
            /// </summary>
            /// <param name="assemblyName">Name of the assembly.</param>
            public GacAssemblyName(Utilities.Win32.Win32Interfaces.IAssemblyName assemblyName)
            {
            ...
            /// <returns></returns>
            public string GetDisplayName(Utilities.Win32.Win32Enums.ASM_DISPLAY_FLAGS flags)
            {
                uint bufferSize = 255;
            ...
            public byte[] PublicKeyToken
            {
                get
                {
                    ...
                    m_assemblyName.GetProperty(Utilities.Win32.Win32Enums.ASM_NAME.ASM_NAME_PUBLIC_KEY_TOKEN, buffer, ref bufferSize);
                    for (int i = 0; i < 8; i++)
                    {
            ...
            public byte[] PublicKey
            {
                get
                {
                    uint bufferSize = 512;
                    IntPtr buffer = Marshal.AllocHGlobal((int)bufferSize);
                    m_assemblyName.GetProperty(Utilities.Win32.Win32Enums.ASM_NAME.ASM_NAME_PUBLIC_KEY, buffer, ref bufferSize);
            ...
            public CultureInfo Culture
            {
                get
                {
                    uint bufferSize = 255;
                    IntPtr buffer = Marshal.AllocHGlobal((int)bufferSize);
                    m_assemblyName.GetProperty(Utilities.Win32.Win32Enums.ASM_NAME.ASM_NAME_CULTURE, buffer, ref bufferSize);
        ...
        /// <summary>
        /// Wraps <see cref="Utilities.Win32.Win32Interfaces.IAssemblyEnum"/>
        /// </summary>
        [CLSCompliant(false)]
        public class GacAssemblyEnum : IComWrapper<Win32Interfaces.IAssemblyEnum>, IEnumerable<GacAssemblyName>
        {
            private Utilities.Win32.Win32Interfaces.IAssemblyEnum m_assemblyEnum;

            /// <summary>
            /// Initializes a new instance of the <see cref="GacAssemblyEnum"/> class.
            /// </summary>
            /// <param name="assemblyEnum">The assembly enum.</param>
            public GacAssemblyEnum(Utilities.Win32.Win32Interfaces.IAssemblyEnum assemblyEnum)
            {
            ...
            private class AssemblyEnumerator : IEnumerator<GacAssemblyName>
            {
                ...
                {
                    Utilities.Win32.Win32Interfaces.IAssemblyName next;
        ...
        public class GlobalAssemblyCache
        {
            ...
            /// <summary>
            /// Wrapper around <see cref="Utilities.Win32.ExternalMethods.CreateAssemblyCache"/>
            /// </summary>
            /// <returns></returns>
            public static Utilities.Win32.Win32Interfaces.IAssemblyCache Win32CreateAssemblyCache()
            {
                Utilities.Win32.Win32Interfaces.IAssemblyCache result;
                ExternalMethods.CreateAssemblyCache(out result, 0);
                return result;
            }

            /// <summary>
            /// Wrapper around <see cref="Utilities.Win32.ExternalMethods.CreateAssemblyNameObject"/>.
            ...
            /// <returns></returns>
            public static Utilities.Win32.Win32Interfaces.IAssemblyName Win32CreateAssemblyName(string name)
            {
            ...
            /// <returns></returns>
            public static Utilities.Win32.Win32Interfaces.IAssemblyName Win32CreateAssemblyName(string name, Utilities.Win32.Win32Enums.CREATE_ASM_NAME_OBJ_FLAGS flags)
            {
                Utilities.Win32.Win32Interfaces.IAssemblyName result;
                ExternalMethods.CreateAssemblyNameObject(out result, name, flags, (IntPtr)0);
                return result;
            }

            /// <summary>
            /// Wrapper around <see cref="Utilities.Win32.ExternalMethods.CreateAssemblyEnum"/>.
            /// Enumerates only the GAC with no filter.
            /// </summary>
            /// <returns></returns>
            public static Utilities.Win32.Win32Interfaces.IAssemblyEnum Win32CreateAssemblyEnum()
            {
            ...
            /// <returns></returns>
            public static Utilities.Win32.Win32Interfaces.IAssemblyEnum Win32CreateAssemblyEnum(Utilities.Win32.Win32Interfaces.IAssemblyName filterName)
            {
            ...
            /// <returns></returns>
            public static Utilities.Win32.Win32Interfaces.IAssemblyEnum Win32CreateAssemblyEnum(Utilities.Win32.Win32Interfaces.IAssemblyName filterName, Utilities.Win32.Win32Enums.ASM_CACHE_FLAGS flags)
            {
                Utilities.Win32.Win32Interfaces.IAssemblyEnum result;
                ExternalMethods.CreateAssemblyEnum(out result, (IntPtr)0, filterName, flags, (IntPtr)0);
                return result;
            }

            /// <summary>
            /// Wrapper around <see cref="Utilities.Win32.ExternalMethods.CreateInstallReferenceEnum"/>
            /// </summary>
            /// <param name="name">The assembly name for which the references are enumerated.</param>
            /// <returns></returns>
            public static Utilities.Win32.Win32Interfaces.IInstallReferenceEnum Win32CreateInstallReferenceEnum(Utilities.Win32.Win32Interfaces.IAssemblyName name)
            {
                Utilities.Win32.Win32Interfaces.IInstallReferenceEnum result;
                ExternalMethods.CreateInstallReferenceEnum(out result, name, 0, (IntPtr)0);
                return result;
            }

            /// <summary>
            /// Wrapper around <see cref="Utilities.Win32.ExternalMethods.GetCachePath"/>
            /// </summary>
            /// <param name="flags">The flags.</param>
            /// <returns></returns>
            public static string Win32GetCachePath(Utilities.Win32.Win32Enums.ASM_CACHE_FLAGS flags)
            {
                uint bufferSize = 255;
                StringBuilder buffer = new StringBuilder((int)bufferSize);
            ...
            /// <param name="flags">Exactly one bit from the ASM_CACHE_FLAGS enumeration.</param>
            /// <returns></returns>
            public static GacAssemblyEnum FindAssemblies(GacAssemblyName filterName, Utilities.Win32.Win32Enums.ASM_CACHE_FLAGS flags)
            {
            ...
            [CLSCompliant(false)]
            public static void InstallAssembly(string dll, params Utilities.Win32.Win32Structures.FUSION_INSTALL_REFERENCE[] references)
            {
            ...
            /// <param name="references">The references.</param>
            [CLSCompliant(false)]
            public static void InstallAssembly(string dll, Win32Enums.IASSEMBLYCACHE_INSTALL_FLAG flag, params Utilities.Win32.Win32Structures.FUSION_INSTALL_REFERENCE[] references)
            {
                if (references.Length == 0)
                {
                    references = null;
                }
                Utilities.Win32.Win32Interfaces.IAssemblyCache cache = Win32CreateAssemblyCache();
        ...
        public static class ExternalMethods
        {
            ...
            public static extern void CreateAssemblyCache(out Utilities.Win32.Win32Interfaces.IAssemblyCache ppAsmCache, uint dwReserved);
            ...
            public static extern void CreateAssemblyNameObject(
                out Utilities.Win32.Win32Interfaces.IAssemblyName ppAssemblyNameObj,
                string szAssemblyName,
                Utilities.Win32.Win32Enums.CREATE_ASM_NAME_OBJ_FLAGS dwFlags,
                IntPtr pvReserved
            );
            ...
            public static extern void CreateAssemblyEnum(
                out Utilities.Win32.Win32Interfaces.IAssemblyEnum pEnum,
                IntPtr pUnkReserved,
                Utilities.Win32.Win32Interfaces.IAssemblyName pName,
                Utilities.Win32.Win32Enums.ASM_CACHE_FLAGS dwFlags,
                IntPtr pvReserved
            );
            ...
            public static extern void CreateInstallReferenceEnum(
                out Utilities.Win32.Win32Interfaces.IInstallReferenceEnum ppRefEnum,
                Utilities.Win32.Win32Interfaces.IAssemblyName pName,
                uint dwFlags,
                IntPtr pvReserved
            );
            ...
            public static extern void GetCachePath(
                Utilities.Win32.Win32Enums.ASM_CACHE_FLAGS dwCacheFlags,
            ...
            public static extern IntPtr CreateJobObject(
                [In] ref Utilities.Win32.Win32Structures.SECURITY_ATTRIBUTES lpJobAttributes,
                string lpName
            );
            ...
            internal static extern bool SetInformationJobObjectLimit(
                IntPtr hJob,
                Utilities.Win32.Win32Enums.JobObjectInfoClass JobObjectInfoClass,
            ...
            public static extern bool GetSystemTime(
                out Utilities.Win32.Win32Structures.SYSTEMTIME st
            );
            ...
            public static extern bool SetTimeZoneInformation(
                [In] ref Utilities.Win32.Win32Structures.TIME_ZONE_INFORMATION lpTimeZoneInformation
            );
        }
        ...
        public class Job : IDisposable
        {
            ...
            public void Create()
            {
                ...
                Utilities.Win32.Win32Structures.SECURITY_ATTRIBUTES securityAttributes = new Win32Structures.SECURITY_ATTRIBUTES();
        ...
        public static class Win32Structures
        {
            ...
            public struct JOBOBJECT_BASIC_LIMIT_INFORMATION
            {
                ...
                /// 
                /// </summary>
                public Utilities.Win32.Win32Enums.LimitFlags LimitFlags;
        ...
        public static class Win32Interfaces
        {
            ...
            public interface IAssemblyCache
            {
                ...
                int UninstallAssembly(
                    ...
                    [MarshalAs(UnmanagedType.LPArray)] Utilities.Win32.Win32Structures.FUSION_INSTALL_REFERENCE[] pRefData,
                ...
                void QueryAssemblyInfo(
                    uint dwFlags,
                    [MarshalAs(UnmanagedType.LPWStr)] string pszAssemblyName,
                    ref Utilities.Win32.Win32Structures.ASSEMBLY_INFO pAsmInfo
                );
                ...
                void InstallAssembly(
                    Utilities.Win32.Win32Enums.IASSEMBLYCACHE_INSTALL_FLAG dwFlags,
            ...
            public interface IAssemblyName
            {
                ...
                /// <returns></returns>
                [PreserveSig]
                int SetProperty(Utilities.Win32.Win32Enums.ASM_NAME PropertyId, IntPtr pvProperty, uint cbProperty);
                ...
                /// <returns></returns>
                [PreserveSig]
                int GetProperty(Utilities.Win32.Win32Enums.ASM_NAME PropertyId, IntPtr pvProperty, ref uint pcbProperty);
                ...
                int GetDisplayName(
                    ...
                    Utilities.Win32.Win32Enums.ASM_DISPLAY_FLAGS dwDisplayFlags
                );
                ...
                [PreserveSig]
                int IsEqual(IAssemblyName pName, Utilities.Win32.Win32Enums.ASM_CMP_FLAGS dwCmpFlags);
            ...
            public interface IInstallReferenceItem
            {
                ...
                [PreserveSig]
                int GetReference(
                    [MarshalAs(UnmanagedType.LPArray)] out Utilities.Win32.Win32Structures.FUSION_INSTALL_REFERENCE[] ppRefData,
                    uint dwFlags,
                    IntPtr pvReserved
                );
            }
        ...
        {
            Utilities.Win32.Win32Structures.SYSTEMTIME result;
        ...
        public static void SetSystemTimeZone(Utilities.Win32.Win32Structures.TIME_ZONE_INFORMATION tzInfo)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<Utilities.Win32.Win32Structures.TIME_ZONE_INFORMATION> GetSystemTimeZones()
        {
            if (s_systemTimeZones == null)
            {
                ...
                using (RegistryKey keys = Registry.LocalMachine.OpenSubKey(@"SOFTWARE\Microsoft\Windows NT\CurrentVersion\Time Zones"))
                {
                    foreach (string key in keys.GetSubKeyNames())
                    {
                        ...
                        {
                            Utilities.Win32.Win32Structures.TIME_ZONE_INFORMATION tzInfo = new Utilities.Win32.Win32Structures.TIME_ZONE_INFORMATION();
