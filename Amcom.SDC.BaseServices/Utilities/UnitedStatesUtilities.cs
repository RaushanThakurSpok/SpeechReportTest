...
namespace Utilities
{
    ...
    public static class UnitedStatesUtilities
    {
        ...
        /// <summary>
        /// Attempts to find a <see cref="Utilities.UnitedStatesUtilities.USState"/>
        /// by its abbreviate.
        /// </summary>
        /// <param name="abbreviation">The abbreviation of the state to search for. Not case sensitive.</param>
        /// <returns>
        /// The <see cref="Utilities.UnitedStatesUtilities.USState"/> that represents the
        /// <c>abbreviation</c>, or if it is not found, throws a <see cref="Utilities.UnitedStatesUtilities.StateNotFoundException"/>
        /// </returns>
        /// <exception cref="Utilities.UnitedStatesUtilities.StateNotFoundException"></exception>
