...
#Region "Methods"
    ...
    End Function
    <Extension()> _
    Public Function CorrectNull(ByVal reader As System.Data.SqlClient.SqlDataReader, ByVal field As String, ByVal [default] As DateTime) As DateTime
        Dim index As Integer = 0
        Try
            index = reader.GetOrdinal(field)
        Catch ex As Exception
    ...
    End Function
    <Extension()> _
    Public Function CorrectNull(ByVal reader As System.Data.SqlClient.SqlDataReader, ByVal field As String, ByVal [default] As Char) As Char
        Dim index As Integer = 0
        Try
            index = reader.GetOrdinal(field)
        Catch ex As Exception
    ...
    End Function
    <Extension()> _
    Public Function FormatNonPrintable(ByVal s As String) As String
        Return FormatData(s, FormatDataStyles.nonPrint)
    End Function
    <Extension()> _
    Public Function Since(ByVal d As DateTime) As String
        Dim secs = Math.Abs(DateDiff(DateInterval.Second, Now, d))
