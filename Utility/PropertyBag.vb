...
Namespace UISupport
    ...
    ''' </summary> 
    Public Class PropertyBagRequestValuesEventArgs
        Inherits EventArgs
        Private _key As String
    ...
    Public Class PropertyBag
        ...
        Public Event RequestValues As EventHandler(Of PropertyBagRequestValuesEventArgs)
...
#End Region
        ...
        Private _values As String() = Nothing
        ''' <summary> 
        ...
        Public Sub OnRequestValues(ByVal key As String)
            RaiseEvent RequestValues(Me, New PropertyBagRequestValuesEventArgs(key))
        End Sub
        Public Sub SetRequestedValues(ByVal ParamArray values() As String)
            _values = values
        End Sub
        Public ReadOnly Property RequestedValues() As String()
            Get
                Return _values
            End Get
        End Property
...
#Region "ICustomTypeDescriptor explicit interface definitions"
        ...
        Private Function GetDefaultProperty() As PropertyDescriptor Implements ICustomTypeDescriptor.GetDefaultProperty
            ...
            If propertySpec IsNot Nothing Then
                Return New PropertySpecDescriptor(propertySpec, Me, propertySpec.DisplayName, Nothing)
            Else
                Return Nothing
            End If
        End Function
        ...
        Private Function GetProperties(ByVal attributes As Attribute()) As PropertyDescriptorCollection Implements ICustomTypeDescriptor.GetProperties
            ...
            For Each [property] As PropertySpec In m_properties
                ...
                ' it to the list. 
                Dim pd As New PropertySpecDescriptor([property], Me, [property].DisplayName, attrArray)
                props.Add(pd)
            Next
...
#End Region
    ...
    Public Class PropertyTable
        ...
        Protected Overloads Overrides Sub OnGetValue(ByVal e As PropertySpecEventArgs)
            e.Value = propValues(e.[Property].DisplayName)
            MyBase.OnGetValue(e)
        End Sub
        ...
        Protected Overloads Overrides Sub OnSetValue(ByVal e As PropertySpecEventArgs)
            propValues(e.[Property].DisplayName) = e.Value
            MyBase.OnSetValue(e)
        End Sub
    End Class
End Namespace