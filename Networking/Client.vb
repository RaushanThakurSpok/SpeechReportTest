...
#Region "Methods"
        ...
        Private Sub HandleTCPRead(ByVal ar As System.IAsyncResult)
            ...
            Catch ex As InvalidOperationException
                ...
                Exit Sub
            Catch ex As Exception
                App.ExceptionLog(New AmcomException("Exception in TCPClient: " & ex.Message, ex))
                GenerateDisconnectEvent()
                Exit Sub
            End Try
            If numbytes > 0 Then
        ...
        Public Sub Send(ByVal data As String)
            ...
            If t.GetString(b) <> data Then
                Dim dbcs As New Text.UTF8Encoding
                b = dbcs.GetBytes(data)
            End If
        ...
        Protected Sub OnReceive(ByVal sender As Object, ByVal e As ClientDataReceivedEventArgs)
            App.TraceLog(TraceLevel.Verbose, "TCPCLIENT OnReceive(){0}{1}", vbCrLf, e.Data)
