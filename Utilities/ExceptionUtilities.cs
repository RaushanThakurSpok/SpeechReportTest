...
namespace Utilities
{
    ...
    public static class ExceptionUtilities
    {
        ...
        /// will be thrown is a <see cref="Utilities.Exceptions.WrappedException"/>
        /// with all exceptions as a chain of Inner exceptions in WrappedException objects
        /// </summary>
        /// <param name="exceptions">The exceptions.</param>
        /// <exception cref="Utilities.Exceptions.WrappedException">If <paramref name="exceptions"/> has more than one element.</exception>
