    ...
    Friend Class Configuration
        ...
        Public Sub New()
            ...
            If App.ApplicationType = ApplicationType.NoConfigConsole OrElse App.ApplicationType = ApplicationType.NoConfigComponent Then
                ...
                Exit Sub
            End If
            Dim providers As XmlNode = App.Config.GetNode(ConfigSection.modules, "notification/pluggableProviders")
            ...
            For Each pageServer As XmlNode In providers.SelectNodes("pagingProvider")
                ...
                _pageList.Add("implementation", pageServer.SelectSingleNode("implementationDll").InnerText)
            ...
            For Each emailServer As XmlNode In providers.SelectNodes("emailProvider")
                _emailList.Add("priority", emailServer.Attributes.GetNamedItem("priority").Value)
                _emailList.Add("implementation", emailServer.SelectSingleNode("implementationDll").InnerText)
                For Each configParam As XmlNode In emailServer.SelectNodes("config")
                    For Each param As XmlNode In configParam.ChildNodes
                        If (param.Name.ToUpper = "USER" OrElse param.Name.ToUpper = "PASSWORD") AndAlso param.InnerText IsNot Nothing Then
                            ...
                            If Not param.InnerText.StartsWith("ENC(") Then
